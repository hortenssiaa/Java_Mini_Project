...
public class MypageUI { // with MemberDAO, MemberMgr, MemberVO
		...
		while (run) {
			...
			switch (menu) {
				...
				case SHOW_MY_REVIEW: // 내가 쓴 후기
					ArrayList<ArrayList<HashMap<String, Object>>> duList = splitArrayList(loginInfo.getMember_id(), memberMGR.myReview(loginInfo.getMember_id()));
	...
	private ArrayList<ArrayList<HashMap<String, Object>>> splitArrayList(String member_id, ArrayList<HashMap<String, Object>> paramList) { 	// ArrayList 속의 ArrayList
		
		ArrayList<HashMap<String, Object>> receivedList = paramList;
	...
	private void myReview(ArrayList<ArrayList<HashMap<String, Object>>> dualList, int page) {
		...
		if (dualList == null) {
			...
			for(int j=0; j<dualList.get(page).size(); j++) {
					...
					System.out.println("┃ * 作成日\t: " + dualList.get(page).get(j).get("CREDATE"));
					System.out.println("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
			}
	...
	public void orderedProduct(String member_id) { //구매상품
