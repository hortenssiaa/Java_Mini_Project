...
#category li .readAll {background-position: -10px -216px;}
...
<body>
	<ul id="category" >
        ...
        <li id="readAll" data-order="6"> 
            <span class="category_bg readAll"></span>
            <input type="radio" id="inp_readAll" value="전체보기" name="categories"/>
		    <label for="inp_readAll">전체보기</label>
        </li>      
        <li id="home" data-order="7"> 
            <span class="category_bg home"></span>
            <input type="radio" id="inp_home" value="홈" name="categories"/>
		    <label for="inp_home">홈</label>
        </li>      
    </ul>
